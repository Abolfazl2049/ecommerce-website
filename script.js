...
function CartAppear(){
  ...
  var i = 0;
  if(buysome > 0){
    let plus2 = buysome * 125;
    document.getElementById("imgtum").src = "images/image-product-1-thumbnail.jpg";
    document.getElementById("pshoe").textContent = "fall limited edition sneakers";
    document.getElementById("buysome").style.margin = "0";
    document.getElementById("cart-2").style.display = "block";
    document.getElementById("buysome").textContent = "125$ x";
    document.getElementById("Tprice").textContent = buysome + " " + "=" + " " + plus2;
  
    
  }
  else {
    document.getElementById("img-tum").style.display = "none";
    document.getElementById("buysome").textContent = "your cart is empty";
    document.getElementById("cart-2").style.display = "none";
    document.getElementById("p-shoe").textContent = "";
    document.getElementById("buysome").style.margin = "60px";
  }
